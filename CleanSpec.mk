...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/msm8960/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/msm8960/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/msm8960/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/msm8960/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/msm8960/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/msm8960/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/msm8960/system/build.prop)
